...
my $sim_rep_file = "/sc/arion/projects/breen_lab/BrainVar/hyperEditing/148eqtlH_output/HE_scripts/unique_simple_repeats.txt"; # if needed insert the proper path to the file
