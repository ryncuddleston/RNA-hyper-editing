...
transform_script="perl /sc/arion/projects/breen_lab/BrainVar/hyperEditing/148eqtlH_output/HE_scripts/fastq_transform.pl" # if needed insert the proper path before the script name
get_orig_script="perl /sc/arion/projects/breen_lab/BrainVar/hyperEditing/148eqtlH_output/HE_scripts/Get_orig_read.pl" # if needed insert the proper path before the script name
filter_sam_script="perl /sc/arion/projects/breen_lab/BrainVar/hyperEditing/148eqtlH_output/HE_scripts/filter_sam.pl" # if needed insert the proper path before the script name
