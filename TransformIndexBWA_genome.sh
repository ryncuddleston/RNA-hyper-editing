...
bwa_index_soft="/full/path/to/bwa/0.7.15/bwa-0.7.15/bwa" # if needed insert the proper path before the tool name
Trans_script_path="/full/path/to/experiment_name/H276_GABA/HE_scripts" # if needed insert the proper path to the transform scripts ("a2c.pl" "a2g.pl" "a2t.pl" "g2c.pl" "t2c.pl" "t2g.pl")
