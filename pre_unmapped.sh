...
SamToFastq_soft="${10}" # full path + tool name
...
echo -e "$bwa_aln_soft samse -n 50 $genome_ind $pre_dir/$out_pre.sai $source_file -f $pre_dir/$out_pre.aln.sam\n\n"
$bwa_aln_soft samse -n 50 $genome_ind $pre_dir/$out_pre.sai $source_file -f $pre_dir/$out_pre.aln.sam

echo -e "$SamToolsView_soft -bS $pre_dir/$out_pre.aln.sam -o $pre_dir/$out_pre.aln.bam\n\n"
$SamToolsView_soft -bS $pre_dir/$out_pre.aln.sam -o $pre_dir/$out_pre.aln.bam

echo -e "$SamToolsView_soft -b -f4 $pre_dir/$out_pre.aln.bam -o $pre_dir/$out_pre.aln.um.bam\n\n"
$SamToolsView_soft -b -f4 $pre_dir/$out_pre.aln.bam -o $pre_dir/$out_pre.aln.um.bam

echo -e "$SamToFastq_soft bam2fq $pre_dir/$out_pre.aln.um.bam > $pre_dir/$out_pre.aln.um.fastq\n\n"
$SamToFastq_soft bam2fq $pre_dir/$out_pre.aln.um.bam > $pre_dir/$out_pre.aln.um.fastq

read_count=`cat $pre_dir/$out_pre.aln.um.fastq | wc -l`; read_count=$(($read_count/4))
echo "bwa aln unmapped reads: $read_count" >> $stat_file

echo -e "$bwa_mem_soft mem -M -t 5 -k 50 $genome_ind $pre_dir/$out_pre.aln.um.fastq > $pre_dir/$out_pre.mem.sam\n\n"
$bwa_mem_soft mem -M -t 5 -k 50 $genome_ind $pre_dir/$out_pre.aln.um.fastq > $pre_dir/$out_pre.mem.sam 

echo -e "$SamToolsView_soft -bS $pre_dir/$out_pre.mem.sam -o $pre_dir/$out_pre.mem.bam\n\n"
$SamToolsView_soft -bS $pre_dir/$out_pre.mem.sam -o $pre_dir/$out_pre.mem.bam

echo -e "$SamToolsView_soft -b -f4 $pre_dir/$out_pre.mem.bam -o $pre_dir/$out_pre.mem.um.bam\n\n"
$SamToolsView_soft -b -f4 $pre_dir/$out_pre.mem.bam -o $pre_dir/$out_pre.mem.um.bam

echo -e "$SamToFastq_soft bam2fq $pre_dir/$out_pre.mem.um.bam > $pre_dir/$out_pre.mem.um.fastq\n\n"
$SamToFastq_soft bam2fq $pre_dir/$out_pre.mem.um.bam > $pre_dir/$out_pre.mem.um.fastq
